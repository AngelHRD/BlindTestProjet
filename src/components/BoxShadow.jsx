  ...
  return (
    ...
    <div className="bg-blur w-3/5 h-[550px] px-24 py-12 flex flex-col items-center gap-4">
        ...
        <div className="w-full my-3 flex flex-col">
            <h2 className="t-owners">Blin<span className="t-briller">d</span> test</h2>
        ...
        <p className="para">
        Que tu sois un fan inconditionnel de pop, de rock, de rap ou de classiques indémodables, 
        tu trouveras des playlists variées qui mettront tes connaissances à l’épreuve.</p>

        {/* bouton*/}
        <button className="bg-[var(--chartreuse)] w-3/4 h-14 rounded-xl mt-auto btn-text">
        Let's gooo
        </button>
    </div>
    </>
