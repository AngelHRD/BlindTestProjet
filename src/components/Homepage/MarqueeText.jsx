        ...
        <div className='absolute lg:top-[96vh] top-[95dvh] w-full overflow-hidden lg:mt-[-72px]'>
            <div className='scrolling-container relative flex overflow-x-hidden'>
                <div className='marquee1'>
                    <div className='relative z-10 t-briller w-full lg:text-[3.7rem] text-4xl'>
                        - Blindify - Blindify - Blindify - Blindify
                    ...
                    <div className='absolute top-1 left-1 z-0 t-briller-vide w-full lg:text-[3.7rem] text-4xl'>
                        - Blindify - Blindify - Blindify - Blindify
