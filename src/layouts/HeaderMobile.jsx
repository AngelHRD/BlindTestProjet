...
function HeaderMobile() {
    ...
    return (
        <header className='fixed top-[92vh] left-1/2 transform -translate-x-1/2 w-auto px-6 p-2 bg-blur rounded-t-lg flex space-x-16 lg:hidden'>
            {/* Accueil */}
