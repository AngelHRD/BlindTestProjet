        ...
        <>
            <div className='container mx-auto lg:h-[calc(100vh-72px)] flex flex-col'>
                ...
                <div className='flex flex-col items-center mt-20 flex-grow'>
                    <div className='flex bg-blur w-3/5 h-2/3 justify-center p-28'>
                        <div className='w-1/2  flex justify-center '>
                            <div className='aspect-square max-w-full max-h-full rounded-full border border-[chartreuse]'>
                    ...
                    <div className='flex flex-grow items-end mb-5'>
                        <button
